# Mail Application With UI Using Python.
import tkinter
...
class MailApp:
    def __init__(self, master):
        self.master = master
        master.title("Rakesh_Raushan's Mail Application For CodeClause")
    ...
    def send_mail(self):
        ...
        # Connect to the SMTP server {Simple Mail Transfer Protocol}
